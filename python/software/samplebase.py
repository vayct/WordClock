...
class SampleBase(object):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("--led-pwm-lsb-nanoseconds", action="store", help="Base time-unit for the on-time in the lowest significant bit in nanoseconds. Default: 50", default=50, type=int)
	...
	self.parser.add_argument("-cc", "--clock-color", action="store", help="Color mode when running the clock: 1=Rotating RGB; 2=Pulsing Color. Default: 1", default=1, type=int, choices=[1,2])
