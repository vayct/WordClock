...
class WordClock(SampleBase):
    ...
    def setDisplay(self,primary_words=[], primary_color=RED, secondary_words=[], secondary_color=AQUA, tertiary_words=[], tertiary_color = WHITE, fade=0.1):
	    global last_buff
	...
	secondary_color=AQUA
        ...
        while True:
            ...
            self.setDisplay(primary_words,primary_color,secondary_words,secondary_color,tertiary_words,tertiary_color)
            fade_counter += 1
            if fade_counter > 5:
                fade_counter = 0
            secondary_counter += 1
